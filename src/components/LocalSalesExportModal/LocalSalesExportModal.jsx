...
import LocalSalesPrintDoc from "./LocalSalesPrintDoc";

const LocalSalesExportModal = ({
  open,
  onClose,
  ...
  const handleExport = async (e) => {
    ...
    try {
      ...
      console.error("Export Local Sales failed:", error);
      toast.error("Failed to fetch local sales records. Please try again.");
      setLoading(false);
      setLoadingMsg("");
    }
  };
  ...
  return (
    <>
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-visible border border-gray-100 flex flex-col relative my-auto">
          ...
          <form onSubmit={handleExport} className="p-6 space-y-4">
            <div className="bg-blue-50/70 border border-blue-100 rounded-lg p-3 text-xs text-blue-800">
              ...
              Both Customer and Date Range are optional. Leave empty to export <strong>all records</strong> for this section.
            </div>
      ...
      <div style={{ display: "none" }}>
        {printData && <LocalSalesPrintDoc ref={printRef} {...printData} />}
      </div>
    </>
  );
};

export default LocalSalesExportModal;
