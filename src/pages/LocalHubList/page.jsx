      ...
      {showOverview && (
        ...
        >
          <CardUI
            ...
            amount={localExpenseAmount?.hub?.total_exp_cash}
          ...
          <CardUI
            ...
            amount={localExpenseAmount?.hub?.total_exp_gpay}
          ...
          <CardUI
            ...
            amount={localExpenseAmount?.hub?.total_exp_account}
          ...
          <CardUI
            ...
            amount={localExpenseAmount?.hub?.total_rec_cash}
            icon={<CashIcon color="#292D32" width="34" height="34" />}
          ...
          <CardUI
            ...
            amount={localExpenseAmount?.hub?.total_rec_gpay}
            icon={<GpayIcon color="#292D32" width="34" height="34" />}
            titleColor="text-green-800"
            className="w-full"
          />
          <CardUI
            ...
            amount={localExpenseAmount?.hub?.total_rec_account}
            icon={<AccountIcon color="#292D32" width="34" height="34" />}
            titleColor="text-green-800"
            className="w-full"
          />
